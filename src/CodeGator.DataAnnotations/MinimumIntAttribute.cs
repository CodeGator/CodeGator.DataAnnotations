...
/// stated integer value.
/// </summary>
[AttributeUsage(AttributeTargets.Property)]
public class MinimumIntAttribute : ValidationAttribute
{
    // *******************************************************************
    // Properties.
    // *******************************************************************
    ...
    /// <summary>
    /// This constructor creates a new instance of the <see cref="MinimumIntAttribute"/>
    /// class.
    /// </summary>
    public MinimumIntAttribute(int minimumValue)
        ...
        )
    {
        ...
        var convObj = (int)Convert.ChangeType(value, typeof(int));
