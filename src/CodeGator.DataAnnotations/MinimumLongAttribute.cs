...
public class MinimumLongAttribute : ValidationAttribute
{
    // *******************************************************************
    // Properties.
    // *******************************************************************
    ...
    /// <summary>
    /// This constructor creates a new instance of the <see cref="MinimumLongAttribute"/>
    /// class.
    /// </summary>
    public MinimumLongAttribute(long minimumValue)
        ...
        )
    {
        ...
        var convObj = (long)Convert.ChangeType(value, typeof(long));
